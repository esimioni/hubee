...
metadata {
    preferences {
        input (name: 'offset', type: 'decimal', title: 'Value offset', description: '', defaultValue: '0', required: true)
        input (name: 'minInterval', type: 'number', title: 'Minimum report interval', description: 'In seconds', defaultValue: '10800', range: '1..500000000', required: true)
        input (name: 'maxInterval', type: 'number', title: 'Maximum report interval', description: 'In seconds', defaultValue: '21600', range: '0..500000000', required: true)
