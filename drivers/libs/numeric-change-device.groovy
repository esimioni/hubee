...
metadata {
    preferences {
        ...
        input (name: "minInterval", type: "number", title: "Minimum report interval", description: "In seconds", defaultValue: "1", range: "1..500000000", required: true)
        input (name: "maxInterval", type: "number", title: "Maximum report interval", description: "In seconds", defaultValue: "3600", range: "0..500000000", required: true)
